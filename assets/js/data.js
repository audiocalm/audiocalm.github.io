...
window.DEMO_DATA = {
  ...
  tts: {
    ...
    featured: ["cosyvoice3", "mingomni"],
    samples: [
      {
        id: "tts-01",
        dataset: "LibriTTS",
        text: "\"This is my schooling, major; and if one neglects the book, there is little chance of learning from the open land of Providence.\"",
  ...
  sound: {
    ...
    featured: ["tangoflux", "mingomni"],
    samples: [
      {
        id: "sound-01",
        dataset: "AudioCaps",
        text: "A series of electronic beeps as a man is talking while water trickles in the background",
      ...
      },
      {
        id: "sound-02",
        dataset: "AudioCaps",
        text: "An engine revving followed by horn honking and more revving",
      ...
      },
      {
        id: "sound-03",
        dataset: "AudioCaps",
        text: "A man talks and insects buzz",
      ...
      },
      {
        id: "sound-04",
        dataset: "AudioCaps",
        text: "A series of computer mouse clicks followed by a kid crying",
      ...
      },
      {
        id: "sound-05",
        dataset: "AudioCaps",
        text: "Brief clanking followed by a woman speaking and sewing machine working",
      ...
      },
      {
        id: "sound-06",
        dataset: "AudioCaps",
        text: "A crowd of people applauding",
  ...
  music: {
    ...
    featured: ["stableaudio", "unimoe"],
    samples: [
      {
        id: "music-01",
        dataset: "SongDescriber",
        text: "It is an instrumental piano song, with a moody relaxing and gentle tone",
      ...
      },
      {
        id: "music-02",
        dataset: "SongDescriber",
        text: "This midi electronic instrumental has a hopeful and optimistic vibe with melodies that mostly repeat for 4 bars",
      ...
      },
      {
        id: "music-03",
        dataset: "SongDescriber",
        text: "A soft, calming jazz piece with a leading guitar, that's suitable for cafe environment",
      ...
      },
      {
        id: "music-04",
        dataset: "SongDescriber",
        text: "Happy optimistic instrumental song with whistles, xylophone and ukulele that can be used to clap and dance along to",
      ...
      },
      {
        id: "music-05",
        dataset: "SongDescriber",
        text: "Calming instrumental music primarily on piano can be used for relaxing",
      ...
      },
      {
        id: "music-06",
        dataset: "SongDescriber",
        text: "Calming and tense classical music played only on piano with strong variance in change of dynamics (velocity)",
